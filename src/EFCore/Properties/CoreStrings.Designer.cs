...
namespace Microsoft.EntityFrameworkCore.Internal
{
    ...
    public static class CoreStrings
    {
        ...
        /// <summary>
        ///     Lambda expression '{includeLambdaExpression}' is not valid for Include/ThenInclude result operator. The expression should represent a property access: 't =&gt; t.MyProperty', using 'as' operator to access navigations on derived types: 't =&gt; (t as Derived).MyProperty'. For more information on including related data, see http://go.microsoft.com/fwlink/?LinkID=746393.
        /// </summary>
